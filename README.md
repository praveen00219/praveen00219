...
- ✨ Currently working as Software Development Engineer at Nrolled Inc, Canada (Remote).

- 🎓 Successfully completed a Full Stack Web Development [Certification](https://drive.google.com/file/d/1AFr3Ad4WNnLIt6MOIuU5Q0hKQz9XZDov/view?usp=sharing) course – Geekster, Gurugram (Haryana). 
- 🎓 Graduated from MDS University in Ajmer (Rajasthan).
...
- [leetcode](https://leetcode.com/u/Prvn21/): Successfully tackled over 260+ data structures and algorithms (DSA) questions, demonstrating a strong grasp of problem-solving skills 
...
### Interests
- 🌐 Web Development: Specializing in both Backend and Frontend Development to create interactive, user-friendly end-to-end websites. Focused on mastering Software Architecture principles and writing Clean Code to build scalable and maintainable web applications.

### Get in Touch
- 🌐 [Gmail](praveen2192000@gmail.com) | [LinkedIn](https://www.linkedin.com/in/praveen219/)  | [Leetcode](https://leetcode.com/u/Prvn21/) | [Portfolio](https://praveen21-portfolio.netlify.app/)
